export const settings = {
  ...
  newEpisodeBackoff: [30,5,5,5,10,10,10,10,10,10,15,15,15,15,30,30,30,30,60,60,120,120,240,480],
  torrentsPerPage: 4, // Number of torrents to show at a time after searching.
  throttleMbps: 0, // Throttles Swiper to use no more than the given bandwidth.
};
